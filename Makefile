...
OpenslasHMD: gl.o resourceloader.o gameobjects.o maploader.o main.o
	$(CC) -o OpenslasHMD gl.o resourceloader.o gameobjects.o maploader.o main.o -lGLEW -lGL -lopenhmd -lSDL2 -lm -ljson-c -lSDL2_mixer
...
gameobjects.o: gameobjects.c gameobjects.h
	${CC} -c ${CFLAGS} gameobjects.c
